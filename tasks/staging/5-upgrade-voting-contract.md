# [STAGING] Task 5: Upgrade Voting Contract
...
Previous task will likely expire without enough votes, so this is a re-creation of the same proposal.
The previous task is [here](./2-upgrade-voting-contract.md).
...
- Previous task: [Task 2: Upgrade Voting Contract](./2-upgrade-voting-contract.md)
- Store blob transaction: https://nearblocks.io/txns/5iJhctZP72Vdnz3kzxWS6Suh8WH52Pp6z4uA9X6YwGqX
- Proposal creation transaction: https://nearblocks.io/txns/8toU3TQK33TJiLC5QqVDjtLJSFgLYScGwwzNLZojKsdW
- Previous staging voting contract upgrade proposal: https://nearblocks.io/txns/9Hr1bh8eogkRMybP7brFUR7d2puAxJKk9UgLdgk6xgZd
