...
OWNER_ACCOUNT_ID - Gauntlet account ID who is the owner of the claims contract.
...
Gauntlet will then upload this file using the near-claims-processor UI at location `/campaigns/new`
...
near contract call-function as-transaction $CLAIMS_CONTRACT create_campaign json-args '{"merkle_root": [
    ...
    92,
    128
], "claim_end": "1789228321000000000"}' prepaid-gas '100.0 Tgas' attached-deposit '0 NEAR' sign-as $OWNER_ACCOUNT_ID.near network-config mainnet sign-with-keychain send
```
